                            ...
                            <div className="space-y-6">
                                <div className="aspect-video rounded-xl overflow-hidden shadow-lg">
                                    <Image
                                        ...
                                        alt={`${portfolio.title[language]} - Image ${selectedImage + 1}`}
                                        width={800}
                                        height={450}
                                ...
                                <div className="grid grid-cols-4 gap-4">
                                    {portfolio.images.gallery.map((image, index) => (
                                        <button
                                            ...
                                            className={`aspect-video rounded-lg overflow-hidden ${selectedImage === index ? 'ring-4 ring-blue-500' : 'hover:opacity-75'
                                                }`}
                                        >
                                            <Image
                                                src={image}
